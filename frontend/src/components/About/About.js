  ...
  return (
    <div className="aboutUsContainer">
      <div className="aboutUs-intro-img">
        ...
        />
        <div className="aboutUs-introText">
          <div className="aboutUs-welove">
            WE <span>❤️</span> WHAT WE DO!
          </div>
          <p className="aboutUs-description">
            Our passion drives us to create exceptional software solutions. We
            believe in delivering stunning, user-friendly designs.
          </p>
        </div>
      </div>
        ...
        <div className="products-offer">
          <div className="products-offer-card">
            ...
            <p style={{fontSize:'20px'}}>
              ...
              innovative, reliable, and secure systems.
            </p>
          </div>
          <div className="products-offer-card">
            <div className="icon-circle">
          ...
          <div className="products-offer-card">
            ...
            <p style={{fontSize:'20px'}}>
              ...
              services, we stand as your committed business ally.
            </p>
          </div>
          <div className="products-offer-card">
            <div className="icon-circle">
      ...
      <div className="about-members">
        ...
        <div className="member">
          ...
          <div className="member-text">
            <p>
              Abhilash is the driving force behind WorkMomentum, a company
              dedicated to delivering comprehensive and innovative technology
              solutions. With a solid foundation in product development, cloud
              computing, and DevOps, Abhilash has consistently pushed the
              envelope to create cutting-edge solutions that simplify and
              enhance the digital experiences of businesses worldwide.
            </p>
            <p>
              From the beginning, my goal has been to build a company that
              offers end-to-end technology solutions under one roof. Whether
              it's a sophisticated mobile app, a robust cloud infrastructure, or
              seamless DevOps integration, WorkMomentum Solutions is committed
              to delivering excellence. I am immensely proud of what we have
              achieved so far and excited about the innovations we have in the
              pipeline. Thank you for being a part of our journey.
            </p>
            <p>
              Abhilash holds a degree from IIIT. With extensive experience in
              developing products and solutions across various domains, he has a
              proven track record of turning complex problems into simple,
              elegant solutions.
            </p>
          </div>
        </div>
        <div className="member">
          <div className="member-text">
            <p>
              Venkatesh is a key pillar of WorkMomentum, bringing his vast
              expertise in full-stack web application development to the team.
              With a Master's degree in Information Systems from Saint Louis
              University, Missouri, USA, Venkatesh combines deep technical
              knowledge with a passion for creating robust and scalable web
              solutions.
            </p>
            <p>
              Joining WorkMomentum has been a thrilling journey. My focus has
              always been on leveraging the latest technologies to build web
              applications that are not only functional but also scalable and
              user-friendly. I'm proud of our team's dedication and look forward
              to continuing our mission to provide top-notch solutions to our
              clients.
            </p>
            <p>
              With years of experience in developing full-stack web
              applications, Venkatesh has been instrumental in building the
              frameworks and platforms that power WorkMomentum diverse range of
              services. His technical acumen and strategic vision have helped
              the company achieve new heights.
            </p>
          </div>
          <div className="member-image">
...
//           </div>
//           <div className='member-text'>
//             <p>Abhilash is the driving force behind WorkMomentum, a company dedicated to delivering comprehensive and innovative technology solutions. With a solid foundation in product development, cloud computing, and DevOps, Abhilash has consistently pushed the envelope to create cutting-edge solutions that simplify and enhance the digital experiences of businesses worldwide.</p>
//             <p>From the beginning, my goal has been to build a company that offers end-to-end technology solutions under one roof. Whether it's a sophisticated mobile app, a robust cloud infrastructure, or seamless DevOps integration, WorkMomentum Solutions is committed to delivering excellence. I am immensely proud of what we have achieved so far and excited about the innovations we have in the pipeline. Thank you for being a part of our journey.</p>
//             <p>Abhilash holds a degree from IIIT. With extensive experience in developing products and solutions across various domains, he has a proven track record of turning complex problems into simple, elegant solutions.</p>
//           </div>
//         </div>
//         <div className='member'>
//           <div className='member-text'>
//             <p>Venkatesh is a key pillar of WorkMomentum, bringing his vast expertise in full-stack web application development to the team. With a Master's degree in Information Systems from Saint Louis University, Missouri, USA, Venkatesh combines deep technical knowledge with a passion for creating robust and scalable web solutions.</p>
//             <p>Joining WorkMomentum has been a thrilling journey. My focus has always been on leveraging the latest technologies to build web applications that are not only functional but also scalable and user-friendly. I'm proud of our team's dedication and look forward to continuing our mission to provide top-notch solutions to our clients.</p>
