    ...
    return (
        <div className='products'>
            ...
            <div class="why-devops-card animate__animated animate__fadeInUp">
                <h3>Efficiency</h3>
                <p>Save time with automated workflows and rapid deployment</p>
            </div>
            <div class="why-devops-card animate__animated animate__fadeInUp animate__delay-1s">
                <h3>Reliability</h3>
                <p>Ensure consistent and reliable releases with our integrated toolset</p>
            </div>
            <div class="why-devops-card animate__animated animate__fadeInUp animate__delay-2s">
                <h3>Flexibility</h3>
                <p>Use the cloud providers and tools you're already familiar with</p>
            </div>
            <div class="why-devops-card animate__animated animate__fadeInUp animate__delay-3s">
                <h3>Scalability</h3>
                <p>Scale your infrastructure seamlessly as your needs grow</p>
            </div>
            <div class="why-devops-card animate__animated animate__fadeInUp animate__delay-4s">
                <h3>Security</h3>
                <p>Implement security best practices effortlessly with our DevSecOps integration</p>
            </div>
            </div>
